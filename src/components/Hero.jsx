...
export default function Hero() {
  return (
    ...
    justify-center text-center max-w-[800px] w-full mx-auto p-4'>
        ...
        <p className='text-3xl'>IT'S TIME TO GET</p>
        <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-7xl'>SWOLE<span className='text-blue-400'>NORMUS</span></h1>
